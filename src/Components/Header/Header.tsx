...
export default function Header() {
  ...
  return (
    <>
      <header className='fixed top-9 right-0 left-0 hidden md:flex items-center bg-black/50 w-[98%] ipad:w-[90%] mx-auto px-5 ipad:px-8 py-2 ipad:py-3 rounded-3xl backdrop-blur-[6px] z-50'>
        <div className='flex justify-between items-center w-full'>
          <nav className='flex items-center gap-x-5 ipad:gap-x-7'>
            <div>
              <img loading="lazy" src="/images/svgs/logo.svg" alt="コーヒー" />
            </div>
            ...
            <ul className="flex items-center gap-x-5 ipad:gap-x-7 text-lg text-gray-300 tracking-tightest child-hover:text-orange-300">
              <li className='transition-colors'>
                <a href="/"> {t.nav.homePage} </a>
              </li>
              <li className="relative leading-[56px] group">
                <a href="/shop"  className="group-hover:text-orange-300 transition-colors"> {t.nav.shop} </a>
              ...
              <li className="transition-colors">
                <a href="/contact-us" > {t.nav.contactUs} </a>
              </li>
            </ul>
          </nav>

          <div className="flex gap-x-5 lg:gap-x-7 text-orange-200 text-lg">
            <div className="flex gap-x-4 lg:gap-x-5 items-center">
              <div className="relative group">
                <div className="py-3">
                  <svg className="w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                    stroke="currentColor">
                ...
                <div
                  ...
                  <div className="text-xs font-dana-medium tracking-tighter -mb-3.5">
                    <span className="text-gray-400 dark:text-gray-300 cursor-default"> 1 {t.header.items}</span>
                  </div>

                  <div
                    className="max-h-96 overflow-auto border-b border-b-gray-300 dark:border-b-white/30 divide-y divide-gray-100 dark:divide-white/10 child:py-4">
                    <div className="flex gap-x-2 items-center">
                      <a href='/product/coffee' className='w-40 h-24'>
                        <img loading="lazy" src="/images/products/p1.png" alt={t.common.productImage} className='w-full h-full' />
                      </a>
                      <div className="flex flex-col">
                        ...
                        <div className='mt-2'>
                          <div className='flex items-center border-2 border-orange-400 rounded-full px-2 w-max'>
                            <span className='text-2xl/4 cursor-default'>+</span>
                            <span className='mx-2 text-lg'>1</span>
                            <span className='text-3xl/4 cursor-default'>-</span>
                          </div>
                        </div>
                        <div className='flex flex-col mt-2'>
                          <span className="inline-block text-red-600 dark:text-gray-200 text-xs/3 line-through tracking-tighter">
                            15,000,000
                          </span>
                          <span className="inline-block font-bold text-base/5 text-teal-600 dark:text-teal-500 tracking-tighter">
                            175,000,000
                            <span className="text-xs font-bold dark:font-normal"> {t.common.toman} </span>
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between items-center pt-1">
                    <div>
                      <p className="text-gray-600 dark:text-gray-300 text-[11px]"> {t.header.totalPayable} </p>
                      <span className="font-bold text-md"> 350,000 </span>
                      <span className="text-xs font-bold">{t.common.toman}</span>
                    </div>
                    <a href="/order"
              ...
              <span className="cursor-pointer toggle-theme" onClick={toggleTheme}>
                ...
                <svg className="hidden dark:block w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                  stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <a href='/login' className="flex items-center ipad:gap-x-2 tracking-tight">
              <svg className="w-7 h-7 inline-block ipad:hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                strokeWidth="1.5" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round"
                  d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
              </svg>
              <svg className="w-7 h-7 hidden ipad:inline-block" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                strokeWidth="1.5" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round"
                  d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
              </svg>
              <span className="hidden ipad:-webkit-box ipad:max-w-48 ipad:line-clamp-1">{t.common.login} | {t.common.register}</span>
            </a>
          </div>
      ...
      <div className="header-mobile flex fixed top-0 right-0 left-0 items-center justify-between md:hidden bg-white dark:bg-zinc-700 px-4 h-16 z-50">
        <div className="nav-icon-btn" onClick={() => {
          setShowCart(false)
          setShowNavbar(true)
        }}>
          <svg className="w-7 h-7 text-zinc-700 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
            stroke="currentColor">
        ...
        <div
          className={`nav block fixed top-0 w-72 min-h-screen h-screen overflow-y-auto py-3 px-4 bg-white dark:bg-zinc-700 z-20 transition-all ${showNavbar ? "right-0" : "-right-72"}`}>
          <div className="flex justify-between items-center border-b border-b-gray-200 dark:border-b-white/10 mb-5 pb-5">
            <div className="flex gap-x-3">
              <svg className="text-orange-300 w-[31px] h-10" viewBox="0 0 41 40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
...
d="M2.23171 19.8562C1.47605 19.8971 0.892187 20.187 0.504722 20.7149C0.421079 20.829 0.356296 20.9382 0.289874 21.0765C0.131608 21.4085 0.0418141 21.7772 0.0073728 22.2388C-7.48572e-06 22.3334 -0.00246758 22.6391 0.00286262 22.7512C0.0717453 24.2039 0.370647 25.6129 0.851595 26.7493C0.962299 27.0114 1.16854 27.4351 1.39856 27.8733C2.33708 29.6622 3.44699 31.267 4.72624 32.6851C5.0805 33.078 5.54136 33.5491 5.9239 33.9103C7.55043 35.4447 9.40944 36.7128 11.4899 37.7081C13.2004 38.5263 15.055 39.16 17.0677 39.6136C17.8504 39.7899 18.5942 39.9053 19.3109 39.9611C19.7131 39.9923 20.0231 40.0027 20.4303 39.9994C20.7029 39.9969 20.7878 39.9944 21.0063 39.9819C22.2925 39.9082 23.4968 39.6207 24.6247 39.1187C24.9158 38.9891 25.2586 38.8146 25.5411 38.6517C25.9884 38.3947 26.4718 38.0668 26.8581 37.7585L26.8917 37.7314L26.69 37.7289C26.3037 37.7239 25.9868 37.6998 25.6334 37.6485C23.9982 37.4123 22.484 36.6632 20.9694 35.3414C20.6045 35.0227 20.2724 34.7031 19.8202 34.2349C19.3548 33.7533 19.0137 33.3842 18.1608 32.4393C16.9874 31.1395 16.6343 30.7646 15.8524 29.988C13.9676 28.1162 13.5096 27.6625 12.8532 27.0172C10.8014 24.9992 9.19747 23.4865 7.67877 22.1384C7.38848 21.8805 7.25727 21.7655 7.18265 21.7035C6.61683 21.2319 5.90914 20.8278 5.06697 20.4945C4.61349 20.3149 4.07719 20.1458 3.58066 20.025C3.17515 19.9266 2.95785 19.8879 2.67043 19.8641C2.59662 19.8579 2.30059 19.8525 2.23171 19.8562ZM2.25631 21.0431C2.47649 21.1127 2.71676 21.1769 3.17269 21.2889C3.80043 21.4427 4.10507 21.5306 4.39864 21.6418C4.75167 21.7759 4.99808 21.9093 5.26582 22.1109C8.03015 24.1939 9.97527 25.8187 11.6067 27.4084C12.2152 28.0017 13.1799 28.9907 14.0303 29.8939C15.0894 31.0187 15.9394 31.9502 17.9927 34.2349C19.1928 35.5701 19.7779 36.2175 20.336 36.8274C20.4339 36.9349 20.5147 37.024 20.5155 37.0257C20.5164 37.0282 20.3458 37.1998 20.1264 37.4169L20.083 37.4598L19.8005 37.1523C19.2572 36.5616 18.8685 36.1358 17.8246 34.991C15.866 32.843 15.0062 31.9086 14.0156 30.8521C12.7867 29.5414 11.5485 28.2616 10.6145 27.3355C9.27332 26.0061 8.106 24.9521 6.96739 24.0427C6.73286 23.8552 6.51432 23.6952 6.23141 23.5036C5.76686 23.1891 5.37735 22.9528 4.38429 22.3846C3.53351 21.8976 3.14809 21.6676 2.71963 21.391C2.55111 21.2819 2.18579 21.0348 2.17021 21.0194C2.16529 21.0144 2.15955 21.0127 2.25631 21.0431Z" />
              ...
              <svg className="text-orange-300 w-[90px] h-10" viewBox="0 0 138 55" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div className="hidden-submenu" onClick={() => setShowNavbar(false)}>
          ...
          <ul className="child:pr-2.5 space-y-6 text-zinc-600 dark:text-white">
            <li className="flex items-center rounded-md pr-0">
              <a href="/" className="flex items-center gap-x-2">
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"
                  stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <li>
              <div className="flex justify-between items-center">
                <a href="/shop"  className="flex items-center gap-x-2 shop-btn">
                ...
                <div>
                  <span className="open-submenu-btn" onClick={() => setShowSubMenu(!showSubMenu)}>
                    <svg className={`w-4 h-4 transition-all ${showSubMenu ? "" : "rotate-180"}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                      stroke="currentColor">
            ...
            <li className="flex justify-between items-center">
              <a href="/about-us"  className="flex items-center gap-x-2">
            ...
            <li className="flex justify-between items-center">
              <a href="/blogs"  className="flex items-center gap-x-2">
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                  strokeWidth="1.5" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <li className="flex justify-between items-center">
              <a href="/contact-us"  className="flex items-center gap-x-2">
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                  strokeWidth="1.5" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round"
          ...
          <div
            className="pt-7 mt-7 space-y-4 px-2.5 border-t border-t-gray-200 dark:border-t-white/10 text-orange-500 dark:text-orange-300">
            <a href='/login' className="inline-flex gap-x-1.5 items-center">
              <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                strokeWidth="1.5" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round"
                  d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
              </svg>
              <span className='line-clamp-1'>{t.common.login} | {t.common.register}</span>
            </a>
            <br />
            <span className="inline-flex gap-x-2 items-center toggle-theme" onClick={toggleTheme}>
              ...
              <svg className="hidden dark:block w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round"
                  d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
              </svg>
              <span className="block dark:hidden"> {t.common.darkTheme} </span>
               <span className="hidden dark:block"> {t.common.lightTheme} </span>
            </span>
          </div>
        </div>
        ...
        <div>
          <a href="/">
            <svg className="w-27 h-10 text-orange-300" viewBox="0 0 138 55" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M9.97653 1.56084C6.13015 2.7264 3.68246 4.94098 1.70099 9.07875C-2.14539 17.1212 0.710258 25.1636 8.46129 28.0775C11.7249 29.2431 20.4084 29.7676 21.9236 28.7769C22.2733 28.5437 22.6229 26.3292 22.7395 23.5318C22.9726 17.704 22.7395 17.4708 17.3196 17.704C13.4732 17.8788 12.4242 18.753 14.7554 19.802C16.4454 20.5596 17.1448 22.6576 16.6203 24.9305C16.2706 26.2126 15.9792 26.3874 14.6388 26.0378C10.1514 24.9305 8.46129 22.0748 8.46129 15.5477C8.40301 11.7013 8.6944 10.4774 9.80169 8.49597C12.4242 3.83369 7.29571 4.18336 73.4417 4.18336C115.868 4.18336 132.653 4.3582 133.235 4.82443C134.11 5.58205 134.343 18.753 133.468 18.753C133.177 18.753 131.079 16.247 128.806 13.2165L124.668 7.68007H121.172C119.249 7.68007 117.675 7.79663 117.675 7.97146C117.675 8.1463 118.083 8.90392 118.607 9.66154C119.307 10.8271 119.423 12.5172 119.249 18.8695C119.132 23.1238 118.841 27.2033 118.607 27.961C118.141 29.2431 118.2 29.3014 120.356 29.1265L122.629 28.9517L122.804 22.949C122.862 19.6854 123.211 17.0046 123.503 17.0046C123.736 17.0046 125.717 19.6271 127.815 22.8325C131.72 28.8351 132.653 29.5345 136.091 29.1265L137.781 28.9517L137.956 16.7715C138.131 3.0178 137.956 2.37673 134.168 1.32772C132.711 0.919775 112.022 0.686661 72.2179 0.744938C24.0799 0.744938 12.0163 0.919775 9.97653 1.56084Z" />
              <path
                d="M33.2296 7.68023C30.5488 8.32129 26.7607 11.0604 25.362 13.4498C24.6627 14.7319 24.2548 16.5385 24.1965 18.7531C24.1382 21.5505 24.4296 22.4247 25.8283 24.2313C27.9846 27.0287 30.3157 28.4856 34.2786 29.3015C40.5144 30.5836 47.4496 28.0194 49.8973 23.532C54.6178 14.965 48.79 6.92261 38.0085 7.15572C36.4932 7.214 34.3369 7.44711 33.2296 7.68023ZM40.8058 11.3518C41.3303 11.7597 42.3211 12.9836 43.0204 14.0909C46.9833 20.618 40.2813 29.4764 34.6866 25.1055C30.5488 21.8419 30.2574 15.6061 34.1038 12.0511C35.8522 10.4193 39.174 10.1279 40.8058 11.3518Z" />
        ...
        <div
          className={`cart fixed top-0 bottom-0 flex flex-col w-full xs:w-80 min-h-screen h-screen overflow-y-auto py-3 px-4 bg-white dark:bg-zinc-700 z-20 transition-all ${showCart ? "left-0" : "-left-full xs:-left-80"}`}>
          <div className="flex justify-between items-center border-b border-b-gray-200 dark:border-b-white/10 mb-5 pb-5">
            <div className="hidden-cart" onClick={() => setShowCart(false)}>
              <svg className="w-5 h-5 text-zinc-600 dark:text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                strokeWidth="1.5" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
              </svg>
          ...
          <div className="child:pb-4 child:mb-4 child:border-b child:border-b-gray-100 child:dark:border-b-white/10">
            <div className="flex gap-x-1 items-center">
              <a href='/product/coffee' className='min-w-28 w-44 h-24'>
                <img loading="lazy" src="/images/products/p1.png" alt={t.common.productImage} className='w-full h-full' />
              </a>
              <div className="flex flex-col">
                <div className='flex justify-between items-start gap-x-2'>
                ...
                <div className='mt-2'>
                  <div className='flex items-center child:dark:text-white border-2 border-orange-400 rounded-full px-2 w-max'>
                    <span className='text-2xl/4 cursor-default'>+</span>
                    <span className='mx-2 text-lg'>1</span>
                    <span className='text-3xl/4 cursor-default'>-</span>
                  </div>
            ...
            <div className="flex gap-x-1 items-center">
              ...
              <div className="flex flex-col">
                ...
                <div className='mt-2'>
                  <div className='flex items-center child:dark:text-white border-2 border-orange-400 rounded-full px-2 w-max'>
                    <span className='text-2xl/4 cursor-defaul'>+</span>
                    <span className='mx-2 text-lg'>1</span>
                    <span className='text-3xl/4 cursor-defaul'>-</span>
                  </div>
                </div>
                <div className='flex flex-col mt-2'>
                  <span className="inline-block text-red-600 dark:text-gray-200 text-xs/3 line-through tracking-tighter">
          ...
          <div className="text-orange-400 dark:text-orange-300 mt-auto">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-gray-600 dark:text-gray-300 text-[10px]"> {t.header.totalPayable} </p>
                <span className="font-bold text-xs"> 350,000 </span>
                <span className="text-[10px] font-bold">{t.common.toman}</span>
              </div>
              <a href="/order"
      ...
      <div className={`overlay md:hidden transition-all ${(showNavbar || showCart) ? "overlay-open" : "invisible opacity-0"}`} onClick={() => {
        setShowCart(false)
        setShowNavbar(false)
      }}></div>
    </>
