            ...
            <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 md:gap-x-6 pt-9 sm:pt-12 md:pt-20 lg:pt-24">
                    <a href="/shop"
                        ...
                        <span className="text-white font-dana-bold text-2xl/6 md:text-4xl/6 mb-4 md:mb-7">コーヒーの種類</span>
                        <span className="text-white font-dana-medium md:text-xl">ブレンド・フルボディ</span>
                    </a>
                    <a href="/shop"
                        ...
                        <span className="text-white font-dana-bold text-2xl/6 md:text-4xl/6 mb-4 md:mb-7">インスタント
                            パウダー</span>
                        <span className="text-white font-dana-medium md:text-xl">ネスカフェ、ホットチョコレート、マサラ</span>
                    </a>
                </div>
            </div>
        </section>
