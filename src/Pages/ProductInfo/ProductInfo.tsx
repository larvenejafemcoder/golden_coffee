...
export default function ProductInfo() {
    ...
    const showAddCommentAlert = () => {
        Swal.fire({
            text: t.productInfo.reviewSubmitted,
            icon: 'success',
            confirmButtonText: t.common.gotIt
        })
    }
    ...
    return (
        <>
                    ...
                    <div className="product-info-body flex items-center flex-col md:flex-row mt-10">
                        <div className='bg-white dark:bg-zinc-700 p-4 rounded-lg w-full md:w-1/2 ipad:w-1/3'>
                            ...
                            >
                                <SwiperSlide className='flex items-center justify-center cursor-zoom-in relative'>
                                    <div className="swiper-zoom-container">
                                        <img loading="lazy" src="/images/products/p1.png" alt={t.common.productImage} className='h-auto md:h-full max-h-[400px] w-full' />
                                    </div>
                            ...
                            >
                                <SwiperSlide className='flex items-center justify-center'>
                                    <img loading="lazy" src="/images/products/p1.png" alt={t.common.productImage} className='rounded-[5px]' />
                                </SwiperSlide>
                                <SwiperSlide className='flex items-center justify-center'>
                                    <img loading="lazy" src="/images/products/p1.png" alt={t.common.productImage} className='rounded-[5px]' />
                                </SwiperSlide>
                        ...
                        <div className="flex flex-col space-y-4 md:space-y-3 xl:space-y-5 w-full md:w-1/2 ipad:w-2/3 my-4 md:my-0 md:mx-4">
                            ...
                            <div className='bg-white dark:bg-zinc-700 dark:text-white px-4 py-3 rounded-lg'>
                                <h4 className='font-morabba-medium mb-2 ipad:mb-1 lg:mb-4'>{t.productInfo.aboutProduct}</h4>
                                <div className='h-27 ipad:h-20 xl:h-36 xs:h-32 mb-4 ipad:mb-4 xl:mb-6'>
                                    <p className='product-about line-clamp-5 ipad:line-clamp-4 xl:line-clamp-6 text-sm xs:text-base ipad:text-sm xl:text-base'>
                                        私たちは製造工程、製品の種類と品質、サービスと流通において先駆者となり、イランの生産者にとっての模範となり、イランにおけるコーヒー文化の拠点となることを目指しています。イラン国内外の人々によるイラン製品への認識が変わらなければならないと信じ、その目標に向けて情熱的に努力しています。
                                        私たちは製造工程、製品の種類と品質、サービスと流通において先駆者となり、イランの生産者にとっての模範となり、イランにおけるコーヒー文化の拠点となることを目指しています。イラン国内外の人々によるイラン製品への認識が変わらなければならないと信じ、その目標に向けて情熱的に努力しています。
                                        私たちは製造工程、製品の種類と品質、サービスと流通において先駆者となり、イランの生産者にとっての模範となり、イランにおけるコーヒー文化の拠点となることを目指しています。
                                    </p>
                                </div>
                                <div className='flex items-center'>
                                    <span>
                                        {t.productInfo.rating}:
                                    </span>
                            ...
                            <div className='flex justify-between items-center bg-white dark:bg-zinc-700 dark:text-white px-4 py-3 rounded-lg'>
                                <div className='me-2'>
                                    <button className='btn-orange text-sm/4 xs:text-base/4 p-3 rounded-md tracking-tighter' onClick={showAddToCartAlert}>{t.productInfo.addToCart}</button>
                                </div>
                                <div className='flex flex-col text-end'>
                                    ...
                                    <span className='text-green-600 dark:text-green-500 font-dana-bold text-base/3 xs:text-2xl/3'>
                                        2,000,000
                                        <span className='text-[10px] xs:text-sm'> {t.common.toman} </span>
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <section className='comments mb-20 md:mb-28'>
                <div className="container">
                    <h2 className=' text-3xl/normal font-morabba-medium dark:text-white border-b-2 border-b-black dark:border-b-white w-max'>{t.productInfo.yourReview}</h2>
                    <div className="new-comment bg-white dark:bg-zinc-700 border-2 border-dashed border-gray-500 p-4 rounded-lg mt-5 dark:text-white">
                        <div className='mb-8'>
                            <label htmlFor="user-score">{t.productInfo.rating}: </label>
                            <select id="user-score" className='text-black bg-blue-200/30 dark:bg-gray-500 dark:text-white ms-2 py-1 focus:outline-none w-40 rounded-lg'>
                                <option value="عالی">{t.productInfo.excellent}</option>
                                <option value="بسیار خوب">{t.productInfo.veryGood}</option>
                                <option value="خوب">{t.productInfo.good}</option>
                                <option value="متوسط">{t.productInfo.average}</option>
                                <option value="ضعیف">{t.productInfo.poor}</option>
                            </select>
                        </div>
                        <div>
                            <label htmlFor="user-comment-input">{t.productInfo.reviewText}</label>
                            <textarea id='user-comment-input' rows={5} className='w-full focus:outline-none rounded-md text-black bg-blue-200/30 dark:bg-gray-500 dark:text-white px-3 py-2 resize-none -mb-2 mt-2 dark:placeholder:text-gray-300' placeholder={t.productInfo.newComment}></textarea>
                        </div>
                        <button className='btn-orange px-3 py-2 rounded-md mt-6' onClick={showAddCommentAlert}>
                            {t.productInfo.reviewSubmitted}
                        </button>
                    </div>
                    <h2 className=' text-3xl/normal font-morabba-medium dark:text-white border-b-2 border-b-black dark:border-b-white w-max mt-14'>{t.productInfo.comments}</h2>
                    <div className="comments">
                        <div className="flex flex-col gap-y-4 bg-white dark:bg-zinc-700 border-2 border-dashed border-gray-500 p-4 xs:p-5 rounded-lg mt-5 dark:text-white">
                            <div className='flex items-center gap-x-1.5 xs:gap-x-4'>
                                <img loading="lazy" src="/images/avatars/avatar10.png" alt={t.common.userProfile} className='rounded-full w-11 h-11 xs:w-14 xs:h-14' />
                                <div className='w-full'>
                                    ...
                                    <div className='flex justify-between'>
                                        ...
                                        <a href='/login' className='btn-orange text-xs xs:text-sm p-2 rounded font-dana-bold'>{t.auth.loginButton}</a>
                                    </div>
                                </div>
                            </div>
                            <div className='comment-content'>
                                ...
                                <div className="reply-container">
                                    <div className='reply-comment bg-gray-100 dark:bg-zinc-500/60 mx-0 xs:mx-10 mt-8 p-4 xs:p-5 border-2 border-dashed border-gray-500 rounded-lg'>
                                        <div className='flex items-center gap-x-1.5 xs:gap-x-4'>
                                            <img loading="lazy" src="/images/avatars/avatar12.png" alt={t.common.userProfile} className='rounded-full w-11 h-11 xs:w-14 xs:h-14' />
                                            <div>
                        ...
                        <div className="flex flex-col gap-y-4 bg-white dark:bg-zinc-700 border-2 border-dashed border-gray-500 p-4 xs:p-5 rounded-lg mt-5 dark:text-white">
                            <div className='flex items-center gap-x-1.5 xs:gap-x-4'>
                                <img loading="lazy" src="/images/avatars/avatar1.jpg" alt={t.common.userProfile} className='rounded-full w-11 h-11 xs:w-14 xs:h-14' />
                                <div className='w-full'>
                                    <p className='font-dana-bold text-zinc-800 text-base dark:text-white w-max max-w-44 line-clamp-1'> هادی حیدری آذر </p>
                                    <div className='flex justify-between'>
                                        <div className='flex items-center gap-x-2 xs:gap-x-3'>
                                        ...
                                        <div className='text-zinc-700 dark:text-white cursor-pointer' title={t.productInfo.reply} onClick={() => setShowReplyComment(true)}>
                        ...
                        <SwiperSlide>
                            <div
                                ...
                                <a href="#" className="flex relative justify-center items-center">
                                    <img loading="lazy" src="/images/products/p1.png" alt={t.common.productImage}
