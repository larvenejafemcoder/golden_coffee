...
export default function Tickets() {
    ...
    const getSearchLocation = new URLSearchParams(location.search).get('id')

    const showAlert = () => {
        Swal.fire({
            text: 'Your ticket has been sent successfully',
            icon: 'success',
    ...
    return (
        <>
            <TitlePage title="Tickets - User Panel" />
                        ...
                        getSearchLocation ? (
                            <div className="ticket-info bg-gray-200/50 dark:bg-zinc-800 w-full p-4 rounded-lg">
                                <h4 className='text-sm/5 sm:text-base/5 pb-3 border-b-[1px] border-b-gray-400/50'>
                                   A test text with no meaning for the ticket subject
                                </h4>
                                <div className='mt-4'>
                                    <div className="bg-white dark:bg-zinc-700 p-3 w-[85%] sm:w-[500px] rounded-tl-xl rounded-bl-xl rounded-br-xl">
                                        ...
                                        <p className='text-xs/4 xs:text-sm/5 mt-1'>
                                            Hello
                                            <br />
                                            We aim to be a role model for Iranian manufacturers by pioneering the production process, product type and quality, services, and distribution. We aim to be a role model for Iranian manufacturers by pioneering the production process, product type and quality, services, and distribution.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <>
                                ...
                                <div className="add-ticket bg-gray-100 dark:bg-zinc-800 rounded-lg mt-10 p-3 xs:p-5">
                                    <h3 className='font-morabba-medium border-b-[1px] pb-2 border-b-gray-300 dark:border-b-white/30'> Send Ticket </h3>
                                    <div>
                                        <form className='mt-4 xs:mt-5 space-y-5' onSubmit={(event) => event.preventDefault()}>
                                            ...
                                            <div>
                                                <label htmlFor="ticket-title"> Ticket Subject </label>
                                                <input type='text' id='ticket-title' className='w-full p-2 mt-2 rounded-md focus:outline-none border-[1px] border-gray-300 text-sm placeholder:text-zinc-500 dark:placeholder:text-gray-200 dark:bg-blue-200/60' placeholder='Enter your ticket subject...' />
                                            </div>
                                            <div>
                                                <label htmlFor="ticket-body"> Ticket Message </label>
                                                <textarea rows={6} type='text' id='ticket-body' className='w-full p-2 mt-2 rounded-md focus:outline-none border-[1px] border-gray-300 text-sm placeholder:text-zinc-500 dark:placeholder:text-gray-200 dark:bg-blue-200/60 resize-none' placeholder='Enter your ticket message...' />
                                            </div>
                                            <button className='btn-orange p-2 px-3 rounded' onClick={showAlert}> Send Ticket </button>
                                        </form>
                                    </div>
                                </div>
                                <div className="my-ticket bg-gray-100 dark:bg-zinc-800 rounded-lg mt-10 p-3 xs:p-5">
                                    <h3 className='font-morabba-medium border-b-[1px] pb-2 border-b-gray-300 dark:border-b-white/30'> My Tickets </h3>
                                        ...
                                        <div className="ticket mt-3 flex flex-col gap-3 bg-white dark:bg-zinc-700 p-2 xs:p-3 rounded-md">
                                            <h4 className='text-sm/4 sm:text-base/5 line-clamp-2'>
                                                <a href="?id=12" className='hover:text-orange-500 dark:hover:text-orange-400 transition-colors'>
                                                    Test text with no meaning
                                                </a>
                                            </h4>
                                            <div className='flex gap-1 xs:gap-2 flex-wrap'>
                                                <span className='text-xs text-center bg-green-200/60 dark:bg-green-200 p-1 tracking-tighter rounded text-green-700'> Replied </span>
                                                <span className='text-xs text-center bg-yellow-200/50 dark:bg-yellow-100 font-dana-bold p-1 tracking-tighter rounded text-yellow-600'> Contact Management </span>
                                        ...
                                        <div className="ticket mt-3 flex flex-col gap-3 bg-white dark:bg-zinc-700 p-2 xs:p-3 rounded-md">
                                            <h4 className='text-sm/4 sm:text-base/5 line-clamp-2'>
                                                <a href="?id=13" className='hover:text-orange-500 dark:hover:text-orange-400 transition-colors'>
                                                    We aim to be a role model for Iranian manufacturers by pioneering the production process, product type and quality, services, and distribution.
                                                    We aim to be a role model for Iranian manufacturers by pioneering the production process, product type and quality, services, and distribution.
                                                </a>
                                            </h4>
                                            <div className='flex gap-1 xs:gap-2 flex-wrap'>
                                                <span className='text-xs text-center bg-red-200/60 dark:bg-red-200 p-1 tracking-tighter rounded text-red-700'> Not Replied </span>
                                                <span className='text-xs text-center bg-yellow-200/50 dark:bg-yellow-100 font-dana-bold p-1 tracking-tighter rounded text-yellow-600'> Consulting </span>
                                                <span className='text-xs text-center bg-gray-300/50 dark:bg-white/90 font-dana-bold p-1 tracking-tighter rounded text-gray-600'> 1402/12/25</span>
                                            </div>
                                        </div>
                                    </div>
