...
export default function Counter() {
    ...
    return (
        <>
            <TitlePage title={t.userPanel.dashboard} />
            <section className='counter'>
                <div className="container-2xl">
                    <div className='boxes-container grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        <CounterBox
                            boxColor="bg-sky-500"
                            title={t.userPanel.myOrders}
                            count={1500}
                            subTitle={t.userPanel.order}
                    ...
                    <div className='mt-8 xs:mt-10'>
                        <p className='text-sm/4'>
                            ...
                            <span className='font-dana-bold tracking-tight text-base'> Hadi Heidari Azar </span>
                            {t.userPanel.notYou}
                            <span className='cursor-pointer hover:font-bold transition-all'> {t.userPanel.logout} </span>
                            )
                        </p>
                    </div>
                </div>
